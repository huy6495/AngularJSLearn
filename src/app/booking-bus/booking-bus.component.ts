...
@Component({
  ...
  styleUrls: ['./booking-bus.component.css']
})
  ...
  seatList: Seat[] =[
    ...
    {SoGhe : 1 ,TenGhe : "số 1 " , Gia :100 , TrangThai :false},
     ...
     {SoGhe : 5 ,TenGhe : "số 5 " , Gia :100 , TrangThai :false},
      ...
      {SoGhe :34 ,TenGhe : "số 34 " , Gia :100 , TrangThai :true}, 
    ...
    onSelect(e: Seat){
      let index = this.selectedList.findIndex((seat)=>seat.SoGhe === e.SoGhe)
      if(index==-1){
    ...
    onCancel(soGhe: number){
      console.log(soGhe)
      this.selectedList = this.selectedList.filter((item)=>item.SoGhe !== soGhe);
